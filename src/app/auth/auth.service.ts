...
export class AuthService {
    ...
    private _getProfile(authResult: auth0.Auth0DecodedHash): void {
    ...
    private _setSession(authResult: auth0.Auth0DecodedHash, profile?: auth0.Auth0UserProfile): void {
    ...
    scheduleRenewal(): void {
        ...
        // Unsuscribe from previous expiration observable
        this.unscheduleRenewal();
